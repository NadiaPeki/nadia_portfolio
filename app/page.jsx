...
const Homepage = () => {
  return (
    <div className="flex flex-col min-h-screen lg:flex-row px-4 lg:px-8 pb-10">
      ...
      <div className="flex flex-col lg:w-1/2 lg:h-auto gap-8 items-center justify-center px-4 mt-10 ">
        {/* Фиксированный отступ для заголовка */}
        ...
        <p className="text-start md:text-lg">
          ...
          elit. At tempora harum illum quidem molestiae ab error dignissimos autem vero. </p>
